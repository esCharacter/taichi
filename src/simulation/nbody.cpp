...
protected:
    struct Node {
        Particle p;
        int children[8]; // We do not use pointer here to save memory bandwidth(64 bit v.s. 32 bit)
...
public:
    ...
    void initialize(real resolution, real margin_real, const std::vector<Particle> &particles) {

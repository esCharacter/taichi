...
if __name__ == '__main__':
    ...
    #tex_ball = tc.Texture('sphere', center=(0.35, 0.5, 0.5), radius=0.08) * 10
    #mpm.add_particles(density_tex=tex_ball.id, initial_velocity=(0.5, 0, 0), compression=0.9)

    tex_ball = tc.Texture('sphere', center=(0.8, 0.5, 0.5), radius=0.08) * 10
    mpm.add_particles(density_tex=tex_ball.id, initial_velocity=(-0.3, 0.1, 0), compression=1.0)
